...
Last updated: 2026-06-20 11:39 CEST
...
- [x] Source repo exists and is clean. Evidence: `/home/dibanez/k8s/libreplay` on `main`, head `ebaf65c feat: add double-submit csrf for api mutations`.
- [x] GitOps runtime manifest is deployed and pushed. Evidence: `/home/dibanez/k8s/k8s-libreplay-pocharlies` on `deploy/prod`; current runtime manifest commit `b8b4b38 feat: deploy libreplay csrf gate` is pushed and GitOps CI run `27867139549` completed `success`.
- [x] LAN runtime is healthy. Evidence: Argo `libreplay` is `Synced|Healthy|b8b4b38906926fc8633f584acb93a5f3c02321ca|k8s`; runtime web image `sha-ebaf65ce0676@sha256:51c24aaade3438245648889a004246934e45d7d7576e81ed1c2bead334c8645b`, worker image `worker-sha-ebaf65ce0676@sha256:6e8a69bdd6d92f4910f6d9f4d68001580d14c78381b3803672e1acfbfd30aeb2`.
...
- [x] Full LAN E2E is green. Evidence: `NODE_TLS_REJECT_UNAUTHORIZED=0 BASE_URL=https://libreplay.lan.e-dani.com PWRETRIES=0 pnpm --filter @libreplay/web exec playwright test --reporter=line` -> `95 passed (1.6m)`.
