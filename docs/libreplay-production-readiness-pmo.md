...
- [x] GitOps runtime manifest is deployed and pushed. Evidence: `/home/dibanez/k8s/k8s-libreplay-pocharlies` on `deploy/prod`; functional runtime manifest commit `f65342d fix: deploy libreplay payment ledger scaffold` is pushed and GitOps CI run `27864058325` completed `success`.
- [x] LAN runtime is healthy. Evidence: Argo `libreplay` synced healthy after the `f65342d` rollout; runtime web image `sha-df168914672d@sha256:c75d9ef07b1648e9f1c307d090c0777239bfecb81b7b0c8e8db442f6f44376c2`, worker image `worker-sha-df168914672d@sha256:91d9f9c62c78c47f9899d63b4d309b8ae67e70ed3cabd547015d7f2524b4b158`.
