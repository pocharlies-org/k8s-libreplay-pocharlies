...
Last updated: 2026-06-20 10:43 CEST
...
- [x] Source repo exists and is clean. Evidence: `/home/dibanez/k8s/libreplay` on `main`, head `2aba268 test(web): stabilize mock payment posture tests`.
- [x] GitOps runtime manifest is deployed and pushed. Evidence: `/home/dibanez/k8s/k8s-libreplay-pocharlies` on `deploy/prod`; current runtime manifest commit `a2b199d fix: prevent staging monitoring drift` is pushed and GitOps CI run `27865708701` completed `success`.
- [x] LAN runtime is healthy. Evidence: Argo `libreplay` is `Synced|Healthy|a2b199dc3b9a543f96df0ffbca6dcf40e1f30e95|k8s`; runtime web image `sha-2aba2684d4a4@sha256:554f61bc5fb45324b531e9864686075bc16e2277b2ac7594125e32d7b8d08657`, worker image `worker-sha-2aba2684d4a4@sha256:8955ceb44849e2f386cd1490e68a5c0e04db68982a55a8e1f27c68a8dfaa7b8e`.
