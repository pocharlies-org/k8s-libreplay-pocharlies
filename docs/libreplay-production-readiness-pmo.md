...
Last updated: 2026-06-21 02:30 CEST / 2026-06-21 00:30 UTC
...
- [blocked] Production media delivery is not complete. Evidence: one 480p MP4/HLS rendition and bucket noncurrent lifecycle are validated, but production still lacks a bitrate ladder, CDN/signed delivery strategy, async progress UI, DB-backed retention/deletion policy, failure replay/dead-letter runbook, real CSAM/media moderation providers and multi-replica worker scaling.
- [ ] Durable media lifecycle exists. Missing: DB retention class/delete/purge fields, purge/orphan cleanup worker, CDN strategy, AV scanning, hash dedupe, backup/restore and legal retention policy for active originals/verification evidence/paid media.
