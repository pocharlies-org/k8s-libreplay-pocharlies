...
Last updated: 2026-06-21 02:16 CEST / 2026-06-21 00:16 UTC
...
- [x] GitOps runtime manifest is deployed and pushed. Evidence: `/home/dibanez/k8s/k8s-libreplay-pocharlies` on `deploy/prod`; current runtime manifest commit `69e7504 fix: deploy staging auth hardening` is pushed and GitOps CI run `27888042812` completed `success`.
- [x] LAN runtime is healthy. Evidence: Argo `libreplay` is `Synced|Healthy|69e7504514ea1f103c0f6b42084e813aa73f3660|k8s`; runtime web image `sha-707a8375192c@sha256:8b47b9d204b84b86d3ede7fde6bb9ea21385ac788919f8d2a433f007a47f2366`, worker image `worker-sha-707a8375192c@sha256:e293049e21eb638a411438bef1d4677075ed7cebbf80aa224732b51a1ea16974`; `/api/health/deps` returned postgres, redis, queues, minio and meilisearch `ok:true`.
