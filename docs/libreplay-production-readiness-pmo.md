...
Last updated: 2026-06-20 10:09 CEST
...
- [x] GitOps runtime manifest is deployed and pushed. Evidence: `/home/dibanez/k8s/k8s-libreplay-pocharlies` on `deploy/prod`; current runtime manifest commit `8f9117a fix: scope libreplay metrics bearer to staging` is pushed and GitOps CI run `27865147747` completed `success`.
- [x] LAN runtime is healthy. Evidence: Argo `libreplay` is `Synced|Healthy|8f9117a9af22d7df5521c6f4f36695d9b9ce273d|k8s`; runtime web image `sha-2aba2684d4a4@sha256:554f61bc5fb45324b531e9864686075bc16e2277b2ac7594125e32d7b8d08657`, worker image `worker-sha-2aba2684d4a4@sha256:8955ceb44849e2f386cd1490e68a5c0e04db68982a55a8e1f27c68a8dfaa7b8e`.
...
- [blocked] Runtime root-cause cleanup and alerting remain incomplete. Evidence: metrics now exist, but production still needs dashboards, alert rules, SLOs, synthetic checks and follow-up root-cause analysis if `P1001` or `ReadableStream is already closed` recurs under load.
...
- [ ] Observability is production-grade. Missing: dashboards, structured logs, error tracking, alerting, SLOs, synthetic checks and recurrence analysis for prior `P1001`/stream-close residuals.
