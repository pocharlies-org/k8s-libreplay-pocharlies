...
Last updated: 2026-06-19 21:20 Europe/Madrid
...
- [ ] Facebook OAuth start redirects to `facebook.com` from staging.
  Evidence required: gated Playwright staging smoke passes.
- [ ] Forgot-password email drains through `auth-email` with no queue failures.
...
BASE_URL=https://staging.libreplay.example.com \
PWRETRIES=0 \
